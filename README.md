...
* [Crossref](http://developer.factual.com/display/docs/Places+API+-+Crossref): Lets you find URLs that contain entities in the Factual places database, or to find the Factual ID of a place mentioned on a URL.
